...
echo "val7 is ". is_nterger($val7); // 1
echo gettype($val7); // integer

$val8 = 34.56;
echo "val8 is ". is_numeric($val8); // 1
echo "val8 is ". is_int($val8); // 1
echo "val8 is ". is_nterger($val8); // 1
echo gettype($val8); // float/double means decimal numeric ---

$val19 = "50";
// ********************
echo "val9 is " .is_numeric($val19); // 1
